...
public class SanFraciscoTab extends Fragment {
    ...
    private void setWeatherInformation() {
        Call<WeatherModel> getWeatherInfo = weatherAPI.getWeatherInfo("San Francisco", "metric", "e6df605f86f15aab601853afee481841");
